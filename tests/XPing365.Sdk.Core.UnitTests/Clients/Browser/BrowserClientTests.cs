...
namespace XPing365.Sdk.Core.UnitTests.Clients.Browser;
...
public sealed class BrowserClientTests
{
    ...
    {
        // BrowserClient manages single context only and thuse previous context has to be close before new can be
        // opened.
