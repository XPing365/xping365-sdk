// This file is part of the XPing365 SDK.
// Licensed under the MIT license. See LICENSE file in the project root for full license information.

using Microsoft.VisualStudio.TestPlatform.ObjectModel.DataCollection;

namespace XPing365.Sdk.Core.Collector;


[DataCollectorFriendlyName("XPing365")]
[DataCollectorTypeUri("xping365://serverdatacollector")]
public class ServerDataCollector : DataCollector
{
    int _i;
    ...
    private void Events_TestCaseEnd(object? sender, TestCaseEndEventArgs e)
    {
        ...
        _logger!.LogWarning(_context!.SessionDataCollectionContext, "TestCaseEnded " + e.TestOutcome.ToString());
    }
