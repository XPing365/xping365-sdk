...
namespace XPing365.Sdk.Core.Clients.Configurations;
...
public class HttpClientFactoryConfiguration : BaseConfiguration
{
    ...
    /// automatically. This allows the XPing365 to handle redirections manually.
    /// </summary>
    ...
    /// the XPing365 to manage cookies in a custom manner.
    /// </summary>
