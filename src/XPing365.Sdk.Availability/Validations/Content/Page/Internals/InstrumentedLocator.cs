...
internal class InstrumentedLocator(TestContext context, ILocator locator) : ILocator
{
    ...
    public ILocator First => new InstrumentedLocator(_context, First);

    public ILocator Last => new InstrumentedLocator(_context, Last);

    public IPage Page => new InstrumentedPage(_context, Page);
        ...
        LocatorSelectOptionOptions? options = null)
    {
        ...
        var result = await _locator.SelectOptionAsync(argValues, options).ConfigureAwait(false);
