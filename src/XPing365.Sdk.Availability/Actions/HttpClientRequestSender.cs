...
/// method.
/// </remarks>
internal sealed class HttpClientRequestSender : TestComponent
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        finally
        {
            ...
            // Clean up httpClientFactory object if the factory is WebApplicationHttpClientFactory because it requires
            // that internal pre-configured HttpClient instance created by the WebApplicationFactory is being disposed.

            // TODO: double check if this has to be disposed!!!!
            //if (httpClientFactory is WebApplicationHttpClientFactory webApplicationHttpClientFactory)
            //{
            //    webApplicationHttpClientFactory.Dispose();
            //}
        }
    }
